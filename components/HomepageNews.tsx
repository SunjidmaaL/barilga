...
export default function HomepageNews() {
  ...
  const EmptyCard = () => (
    <div className="rounded-xl bg-gray-50 border-2 border-dashed border-gray-300 p-8 text-center">
      ...
      <h3 className="text-lg font-semibold text-gray-600">Мэдээ байхгүй байна</h3>
    </div>
  )

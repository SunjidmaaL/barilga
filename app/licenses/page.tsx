  ...
  return (
    <>
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-4 sm:space-y-6">
            <div className="prose max-w-none">
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg sm:rounded-xl p-4 sm:p-6 border-l-4 border-indigo-600">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 my-4 sm:my-6">
                <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-md border border-gray-200 hover:shadow-lg transition-shadow">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-8 sm:pb-12 lg:pb-16">
        ...
        {/* Statistics Table */}
        <div className="overflow-hidden rounded-xl sm:rounded-2xl bg-white shadow-xl border border-gray-200 mb-6 sm:mb-8">
        ...
        {/* Licenses Table */}
        <div className="overflow-hidden rounded-xl sm:rounded-2xl bg-white shadow-xl border border-gray-200">
          <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-300">
              <thead className="bg-gradient-to-r from-gray-50 to-gray-100">
              <tr>
